...
console.log(
  "Display index: ",
  displayWinnerInformation(findIndexWinnerByTicket(004)),
);
console.log(
  "Display index: ",
  displayWinnerInformation(findIndexWinnerByTicket(015)),
);

console.log(
  "Display info: ",
  displayWinnerInformation(findWinnerByName("Jenny")),
);
console.log(
  "Display info: ",
  displayWinnerInformation(findWinnerByName("Sarahi")),
);
